"""
Django settings for incentvest_41428 project.
...
ROOT_URLCONF = 'incentvest_41428.urls'
...
WSGI_APPLICATION = 'incentvest_41428.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "incentvest_41428 API",
    "DESCRIPTION": "API documentation for incentvest_41428 App",
    "VERSION": "v1",
}
